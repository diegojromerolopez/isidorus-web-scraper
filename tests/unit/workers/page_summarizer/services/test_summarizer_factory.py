...
class TestSummarizerFactory(unittest.TestCase):
    ...
    def test_get_llm_openai_with_key(self):
        with patch(
    ...
    @patch.dict(os.environ, {}, clear=True)
    def test_get_llm_gemini_with_key(self):
        with patch(
    ...
    @patch.dict(os.environ, {}, clear=True)
    def test_get_llm_anthropic_with_key(self):
        with patch(
    ...
    def test_summarize_text_real_stuff(self, mock_splitter_cls, mock_load):
    ...
    def test_summarize_text_real_map_reduce(self, mock_splitter_cls, mock_load):
        llm = MagicMock()
        mock_splitter = MagicMock()
        mock_splitter_cls.return_value = mock_splitter
    ...
    def test_summarize_text_exception(self):
        llm = MagicMock()
